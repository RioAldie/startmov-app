...
const DetailSkeleton = () => {
  return (
    <div
      ...
      <div className="flex items-center justify-center w-2/4 h-96 bg-gray-300 rounded sm:w-96 dark:bg-neutral-700">
        <svg
          className="w-56 h-28 text-gray-200 dark:text-neutral-600"
          aria-hidden="true"
